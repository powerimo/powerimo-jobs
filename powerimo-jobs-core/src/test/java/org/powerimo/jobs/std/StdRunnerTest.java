...
class StdRunnerTest {
    ...
    void runArgs_success() throws NoSuchMethodException {
        ...
        System.out.println("(!) An exception is expected here");
    ...
    void runArgs_exception() throws InterruptedException {
        ...
        // Has to be 1 because stateRepository.setCleanupCompleted(false);
        assertEquals(1, runner.getStateRepository().getRunningJobStateList().size());
        var info = stateRepository.getRunningJobStateList().get(0);
